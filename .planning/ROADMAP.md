...
**Phases:** 4 | **Requirements:** 23 | **Coverage:** 100% ✓
...
| 2 | Extension Skeleton | Extension installs in Chrome, survives SW restarts, connects to server, and lets user configure folders and verify logins | INFRA-03, INFRA-04, SETUP-01, SETUP-02, SETUP-03 | 3 criteria |
...
**Goal:** Each transcoded MP4 publishes to Instagram Reels and LinkedIn sequentially using the active Chrome session, captions from `.caption.txt` are included in each post, and a single platform failure does not abort publishing to the remaining platforms.
**UI hint:** no
**Depends on:** Phase 3
